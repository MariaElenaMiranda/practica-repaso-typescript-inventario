...
import { getProductosPorCategoria } from "./services/getProductoPorCategorias";
import { getProductoService } from "./services/getProductoService";

//Elementos del DOM:
const input = document.getElementById('input-producto') as HTMLInputElement;
const btnId = document.getElementById('btn-id') as HTMLButtonElement;
const btnCategoria = document.getElementById('btn-categoria') as HTMLButtonElement;
const contenedorRespuesta = document.getElementById('contenedor-resultados') as HTMLDivElement;

//Función que consume la promesa con .then() y .catch() y muestra los detalles del producto por su id
function mostrarProducto(id : number) : void {
  console.log('----------------------------------------------');
...
async function mostrarProductosCategoria(categoria : string) {
  console.log('-----------------------------------------------');
...
btnId.addEventListener('click', () => {
  ...
  const inputId : number = parseInt(input.value);
...
btnCategoria.addEventListener('click', () => {
  ...
  const inputCategoria : string = input.value;
   //Aqui no es necesario tipar, ya que hay inferencia de tipos (HTMLParagraphElement)
  let mensaje = document.createElement('p');
